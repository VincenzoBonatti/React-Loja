    ...
    return (
        <div className="w-[30%] flex flex-col items-center">
            ...
            <form onSubmit={cadastrar} className="bg-black p-5 flex flex-col items-start justify-center gap-5 w-[100%]">
                <div>
                    <h2>Nome completo:</h2>
                    <input type="text" name="name" className="text-black px-2 py-1 rounded-full w-[100%]"/>
                </div>
                <div>
                    <h2>Email:</h2>
                    <input type="text" name="email" className="text-black px-2 py-1 rounded-full"/>
                </div>
                <div>
                    <h2>Senha</h2>
                    <input type="password" name="senha" id="" className="text-black px-2 py-1 rounded-full"/>
                </div>
